import 'package:first_app/authenticate/login_screen.dart';
import 'package:first_app/main_screen/leave/leave_form.dart';
                ...
                child: Row(
                  ...
                  children: <Widget>[
                    Flexible(
                      ...
                      child: InkWell(
                        onTap: () {
                        Route newRoute = MaterialPageRoute(builder: (_) => const LeaveForm());
                          Navigator.pushReplacement(context, newRoute);
                        },
                        child: Container(
                          color: Colors.cyan,
